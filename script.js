...
const JUDGE_PROFILES = {
  // 🌟 ROUND 3 EXTERNAL + INTERNAL JUDGES (FM001 to FM007 - 8th September 2026)
  'FM001': {
    id: 'FM001',
    group: 'Round 3 Final Panel 1',
    names: ['Mr Anand Patel (External)', 'Dr. P V RAMANA (Internal)'],
    location: 'CE Dept.'
  },
  'FM002': {
    id: 'FM002',
    group: 'Round 3 Final Panel 2',
    names: ['Mr. Jaimin Dalvadi (External)', 'Prof. Viral S Patel (Internal)'],
    location: 'CE Dept.'
  },
  'FM003': {
    id: 'FM003',
    group: 'Round 3 Final Panel 3',
    names: ['Mr. Purnil Soni (External)', 'Prof. Rashmin B Prajapati (Internal)'],
    location: 'CE Dept.'
  },
  'FM004': {
    id: 'FM004',
    group: 'Round 3 Final Panel 4',
    names: ['Mr. Swachil Patel (External)', 'Prof. Rimi V Gupta (Internal)'],
    location: 'CE Dept.'
  },
  'FM005': {
    id: 'FM005',
    group: 'Round 3 Final Panel 5',
    names: ['Mr Hiren Patel (External)', 'Dr. Neha Soni (Internal)'],
    location: 'CE Dept.'
  },
  'FM006': {
    id: 'FM006',
    group: 'Round 3 Final Panel 6',
    names: ['Mr. Amit Parmar (External)', 'Prof. Jayna B. Shah (Internal)'],
    location: 'CE Dept.'
  },
  'FM007': {
    id: 'FM007',
    group: 'Round 3 Final Panel 7',
    names: ['Mr. Tejas Bhatt (External)', 'Prof. Parul V Bakaraniya (Internal)'],
    location: 'CE Dept.'
  },
